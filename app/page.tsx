      ...
      {activeTab === 'dossier' && (
        <div className="bg-zinc-900 rounded-3xl p-8">
          ...
          <div className="grid grid-cols-2 gap-8 text-sm">
            ...
            <div>
              <pcd ~/nova-intelligence
cd ~/nova-intelligence
git add app/page.tsx && git commit -m "FINAL v5.2 - perfected dynamic state across all tabs + document retrieval" --allow-empty && git push -u origin main --force
